...
def include_external_go_mod():
    ...
    go_repository(
        ...
        sum = "h1:GFJMMUmtXT26hoMH72mRTlU+Gnh239m0ltqZb5mSArw=",
        version = "v0.3.1",
    )

    go_repository(
        name = "com_github_apenella_go_common_utils",
        importpath = "github.com/apenella/go-common-utils",
        sum = "h1:dJA2tY22z6mYB5a+EogfiS7NxZsR/Ld3TWnZcS3JPa0=",
        version = "v0.1.1",
    )
    ...
    go_repository(
        ...
        sum = "h1:r4fbYFo6N4ZelmSX8G6p+cv/hZRXzcuqQIADGT1iNKM=",
        version = "v0.19.14",
    )
    ...
    go_repository(
        ...
        sum = "h1:RFTu/dlFySpyVvJDfp/7674JY4SDglYWKztbiIGFpmc=",
        version = "v0.19.11",
    )
    ...
    go_repository(
        ...
        sum = "h1:2QQcyaEBdpfjjYkF0MXc69jZbHb4IOYuXz2UwsmVM8k=",
        version = "v2.0.0-20191107172027-c3144fdedc21",
    )
    ...
    go_repository(
        ...
        sum = "h1:t96dS3DO8DGjawSLJL/HIdz8CycAd2v07XxqB3UPTi0=",
        version = "v0.0.0-20201120155355-20be4ac4bd6e",
    )
