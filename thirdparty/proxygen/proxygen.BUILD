...
genrule(
  ...
  cmd = "sh $(location proxygen/lib/http/gen_HTTPCommonHeaders.sh) $(location proxygen/lib/http/HTTPCommonHeaders.txt) `dirname $(location proxygen/lib/http/HTTPCommonHeaders.txt)`/../../../ $(@D)/proxygen/lib/http",
  outs = [
